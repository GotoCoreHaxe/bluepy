...
@:pythonImport("bluepy.bluepy.sensortag") extern class Sensortag_Module {
	...
	static public var SENSORTAG_V1 : Dynamic;
	static public function _TI_UUID(val:Dynamic):Dynamic;
	...
	static public function calcPoly(coeffs:Dynamic, x:Dynamic):Dynamic;
