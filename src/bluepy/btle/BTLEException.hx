...
package bluepy.btle;
@:pythonImport("bluepy.bluepy.btle", "BTLEException") extern class BTLEException {
	static public var COMM_ERROR : Dynamic;
	static public var DISCONNECTED : Dynamic;
	static public var GATT_ERROR : Dynamic;
	static public var INTERNAL_ERROR : Dynamic;
	static public var MGMT_ERROR : Dynamic;
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(code:Dynamic, message:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(code:Dynamic, message:Dynamic):Void;
	/**
		Return self<=value.
	**/
