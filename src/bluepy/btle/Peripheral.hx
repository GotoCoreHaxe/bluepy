...
package bluepy.btle;
@:pythonImport("bluepy.bluepy.btle", "Peripheral") extern class Peripheral {
	...
	**/
	@:native("__init__")
	public function ___init__(?deviceAddr:Dynamic, ?addrType:Dynamic, ?iface:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?deviceAddr:Dynamic, ?addrType:Dynamic, ?iface:Dynamic):Void;
	/**
		Return self<=value.
	**/
