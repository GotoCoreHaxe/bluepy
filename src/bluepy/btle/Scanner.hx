...
package bluepy.btle;
@:pythonImport("bluepy.bluepy.btle", "Scanner") extern class Scanner {
	...
	**/
	@:native("__init__")
	public function ___init__(?iface:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?iface:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	public function process(?timeout:Dynamic):Dynamic;
	public function scan(?timeout:Dynamic, ?passive:Dynamic):Dynamic;
	public function start(?passive:Dynamic):Dynamic;
