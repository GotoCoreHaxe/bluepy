...
@:pythonImport("bluepy.btle", "UUID") extern class UUID {
	...
	**/
	@:native("__init__")
	public function ___init__(val:Dynamic, ?commonName:Dynamic):Dynamic;
	/**
		We accept: 32-digit hex strings, with and without '-' characters,
		4 to 8 digit hex strings, and integers
	**/
	public function new(val:Dynamic, ?commonName:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	public function getCommonName():Dynamic;
}